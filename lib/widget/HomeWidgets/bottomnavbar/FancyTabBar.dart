    ...
    return Stack(
      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(color: prefix0.Colors.white, boxShadow: [
            BoxShadow(
...
class HalfPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final Rect beforeRect =
        Rect.fromLTRB(0.0, (size.height / 2) - 10, 10.0, 10.0);
    final Rect largeRect = Rect.fromLTWH(10.0, 0.0, size.width - 20, 70.0);
    final Rect afterRect =
        Rect.fromLTRB(size.width - 10, (size.height / 2) - 10, 10.0, 10.0);
    final path = Path();
